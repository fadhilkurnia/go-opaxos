...
//	OriBallot   paxi.Ballot         // the value's original ballot
//	SharesBatch []SecretShare       // a batch of secret-shares of command
//	Commands    []paxi.BytesCommand // a batch of clear command for fellow trusted proposer
//}
//
...
type P1b struct {
	...
	Log    map[int]CommandShare `msgpack:"v"` // uncommitted logs
}
...
type P3 struct {
	...
	OriBallot   paxi.Ballot         `msgpack:"o"` // the value's original ballot
	SharesBatch []SecretShare       `msgpack:"r"` // a batch of secret-shares of command
	Commands    []paxi.BytesCommand `msgpack:"v"` // a batch of clear command for fellow trusted proposer
}
